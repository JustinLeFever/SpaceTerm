...
HD_PWD='C:/Users/lefev/Desktop/SpaceTerm/SpaceTerm.runs/CLK25MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLK25MHz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLK25MHz.tcl
